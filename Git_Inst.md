...
Для того что бы получить данные из удаленного репозитория в локальный поможет команда: `git pill`

Для того что бы что бы отправить данные в удаленный репозиторий команда : `git push`

# Работа с чужими репозиториями 

## 1. На выброном репозитории нажимаем кнопку Fork 

![](Fork.png) 

Создаём копию в своём аккаунте

## 2. Копирум ссылку репозитория
![](codde.png)

## 3. Переходим в наш локальный репозиторий , переходим в корневую папку команда : `cd "Название папки"

## 4. Переходим в терминал пишем команду `git clone "ссылка на репозиторий"

## 5. Переходим в папку с получившимся репозиториям

## 6. Создаём новую ветку командой : git branch "Название ветки"

## 7. Перехидим в созданную ветку командой : git checkout "Название ветки"

## 8. Создаём новый файл командой : touch "название файла"

## Работаем с данным файлом сохраняем изменения командой `git add` "имя файла" git commit -m "комментарий"

## 9 Для того что бы отправить ваши пердложенные изменения автору пишим команду git push --set-upstream Origin "Название файла"

## 10 Перехходим на страницу автора с данным репозитоиям и нажимаем кнопку Pull request
