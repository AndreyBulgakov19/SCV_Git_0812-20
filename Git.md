...
Перейти на сайт [Github](https://github.com/) и зарегистрироваться

Создать репозиторий и скопировать ссылку репозитория 

Если на локальном репозитории нет файлов, пишем следующие команды
```
echo '# remote' >> README.md
git init
git add README.md
git commit -m "Добавили файл README.md"
```
Создался новый файл на локальном репозитории

Далее надо связать локальный репозиторий с удаленным

Для начала переименовываем ветку `master` в `main`
```
git branch -M main
```
после связываем репозитории
```
...
В удаленном репозитории появился файл с локального репозитория

Если в удаленном репозитории уже есть файл и нам из надо перенести в локальный то используем команду
```
git pull
```
...
Находим на [Github](https://github.com/) нужный нам репозиторий на стороннем аккаунте

В правом верхнем углу нажимаем кнопку **fork** 

После этого сторонний репозиторий копируется в личный

Далее копируем ссылку удаленного репозитория и переносим его на локальный
...
Теперь надо создать новую ветку и перейти в неё
```
git branch <имя ветки>
git checkout <имя ветки>
```
Работаем в этой ветки и после делаем **commit**
...
Изменения ушли автору репозитория
